...
## Establish and test database connection; PHP Connect to MySQL
...
## View database records with SELECT* query.
...
Here is a link to the module 10 webpage that runs the .php file tests:
